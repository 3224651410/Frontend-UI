...
public:
	void UpdataDetailsViewInfo(UListDataObject_Base* InDataObject, const FString& InEntryWidgetClassName = FString());
...
private:
	...
	UPROPERTY(meta = (BindWidget))
	UCommonLazyImage* CommonLazyImage_Description;

	UPROPERTY(meta = (BindWidget))
	UCommonRichTextBlock* CommonRichText_Discription;
